...
fun RegisterScreen2(navController:NavHostController) {
    ...
    Column(modifier = Modifier
        ...
        OutlinedTextField(
            ...
            leadingIcon = {Icon(imageVector = Icons.Default.AccountCircle, contentDescription = "icon for name")},
        ...
        OutlinedTextField(
            ...
            leadingIcon = {Icon(imageVector = Icons.Default.Email, contentDescription = "icon for mail")},
        ...
        Button(onClick = {
            val myregister1= AuthViewModel1(navController, context)
            myregister1.signup(email.text.trim(), pass.text.trim(), confirmpass.text.trim())
